...
var steps = [
    { popover: { title: 'Dashboard', description: 'PeopleForever dashboard section' } },
...
if ($('.oh-card-dashboard').length) {
    steps.push({ element: '#tileContainer .oh-card-dashboard:nth-child(1)', popover: { title: 'Dashboard Tiles', description: 'PeopleForever Dashboard Tiles' } });
}
setTimeout(() => {
    ...
    steps.push({ element: '[data-id="dashboardNav"]', popover: { title: 'App', description: 'PeopleForever Hr Apps. eg Dashboard' } });
    }
}, 1000);
driverObj = driver(
